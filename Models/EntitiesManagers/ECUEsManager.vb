...
Public Class ECUEsManager
    ...
    Public Shared Function deleteECUEUEs(ecueId As Integer) As Boolean
        ...
        Return False
    End Function
    Public Shared Function store(ecue As ECUE, ueList As List(Of Integer)) As Boolean
        Try
        ...
        End Try
    End Function
    Public Shared Function update(ecue As ECUE, ueList As List(Of Integer), id As Integer) As Boolean
        Try
