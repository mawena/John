Public Class ECUEsView
    ...
    Private Sub BT_ADD_Click(sender As Object, e As EventArgs) Handles BT_ADD.Click
        ...
        If ECUEsController.insert(TB_LIBELLE.Text, CInt(CB_NB_CREDIT.SelectedItem), CB_TEACHER.Text, ueNameSelectedList) Then
            ClearForm()
            BT_REFRESH_Click(Nothing, Nothing)
        End If
    End Sub
    ...
    Public Sub CheckButtons()
        ...
        End If
    End Sub
    Public Sub Recharge_CB_TEACHER()
