Public Class EmployeesView
    ...
    Private Sub BT_ADD_Click(sender As Object, e As EventArgs) Handles BT_ADD.Click
        If EmployeesController.insert(TB_LAST_NAME.Text, TB_FIRST_NAME.Text, TB_PHONE_NUMBER.Text, TB_EMAIL.Text, CB_GENDER.SelectedItem.ToString(), CB_FUNCTION.SelectedItem.ToString()) Then
            ClearForm()
