...
Public Class StudentsReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "John.StudentsReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStudentsReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StudentsReport2 = New StudentsReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
